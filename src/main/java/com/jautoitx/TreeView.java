...
public class TreeView extends AutoItX {
	 ...
	 *         failed.
	 */
	public static WinDef.LRESULT getHandle(final String title, final String control,
										   final String item) {
	 ...
	 *         failed.
	 */
	public static WinDef.LRESULT getHandle(final String title, final String text,
										   final String control, final String item) {
		WinDef.LRESULT itemHWND = null;
	 ...
	 *         failed.
	 */
	public static WinDef.LRESULT getHandle(final HWND hWnd, final HWND hCtrl,
										   final String item) {
	...
	public static boolean isExpanded(final String title, final String text,
		...
		if (hWnd != null) {
			WinDef.LRESULT itemHWND = getHandle(title, text, control, item);
			if (itemHWND != null) {
	...
	private static WinDef.LRESULT getFirstChildHandle(final String title,
													  final String text, final String control, final WinDef.LRESULT itemHWND) {
		WinDef.LRESULT firstChildHWND = null;
		HWND hWnd = Control.getHandle_(title, text, control);
		if (hWnd != null) {
	...
	private static WinDef.LRESULT getFirstItemHandle(final String title,
			final String text, final String control) {
		WinDef.LRESULT firstItemHWND = null;
		HWND hWnd = Control.getHandle_(title, text, control);
		if (hWnd != null) {
	...
	private static WinDef.LRESULT getNextSiblingHandle(final String title,
													   final String text, final String control, final WinDef.LRESULT itemHWND) {
		WinDef.LRESULT nextSiblingHWND = null;
		if (itemHWND != null) {
			HWND hWnd = Control.getHandle_(title, text, control);
			if (hWnd != null) {
